...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    concat: {
      license: {
        ...
        files: {
          'dist/enhlist/plugin.js': [
            'src/text/license-header.js',
            scratchPluginMinPath
          ],
          'dist/enhlist/plugin.min.js': [
            'src/text/license-header.js',
            scratchPluginMinPath
          ]
        }
    ...
    copy: {
      css: {
        files: [
          ...
          { src: ['changelog.txt'], dest: 'dist/enhlist', expand: true }
        ]
      }
    },
  ...
  grunt.registerTask('version', 'Creates a version file', function () {
    grunt.file.write('dist/enhlist/version.txt', BUILD_VERSION);
  });
